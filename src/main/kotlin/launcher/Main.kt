...
private const val defaultRunAirsync =
    "cmd /k start java -Xms1G -Xmx3G -jar -Dfile.encoding=UTF-8 -jar -server airsync.jar -runnow"
private const val x64RunAirsync =
    "cmd /k start java -d64 -Xms1G -Xmx4G -jar -Dfile.encoding=UTF-8 -jar -server airsync.jar -runnow"
